...
export const mockedPosts = [
  ...
  },
  {
    ...
    attributes: {
      content:
        '# Sic dum rursusque laborent securi spectans levatus\n\n## Nec caput iugulo porrigit\n\nLorem markdownum validoque anum excepto nunc',
      slug: 'laurence-the-first-vicar',
      createdAt: '2022-08-19T19:33:29.172Z',
      updatedAt: '2022-12-28T17:57:03.118Z',
      publishedAt: '2022-08-19T19:33:30.072Z',
      title: 'Laurence, the First Vicar',
      cover: {
        data: {
          id: 15,
          attributes: {
            ...
            formats: {
              large: {
                ext: '.png',
                url: '/images/tests/1666740784814_13889_2_2.png',
                hash: 'large_2_39e32e2911',
                mime: 'image/png',
                name: 'large__2.png',
                path: null,
            ...
            mime: 'image/png',
            size: 2.13,
            url: '/images/tests/1666740784814_13889_2.png',
            previewUrl: null,
            provider: 'cloudinary',
            provider_metadata: {
              public_id: '2_39e32e2911',
  ...
  },
  {
    ...
    attributes: {
      content:
        '# Sic dum rursusque laborent securi spectans levatus\n\n## Nec caput iugulo porrigit\n\nLorem markdownum validoque anum excepto nunc',
      slug: 'lira-orphee-death-trip-serenade',
      createdAt: '2022-08-19T19:33:29.172Z',
      updatedAt: '2022-12-28T17:57:03.118Z',
      publishedAt: '2022-08-19T19:33:30.072Z',
      title: 'Lyra Orphee Death Trip Serenade',
      cover: {
        data: {
          id: 15,
          attributes: {
            ...
            formats: {
              large: {
                ext: '.png',
                url: '/images/tests/1666740784814_13889_3_3.png',
                hash: 'large_2_39e32e2911',
                mime: 'image/png',
                name: 'large__2.png',
                path: null,
            ...
            mime: 'image/png',
            size: 2.13,
            url: '/images/tests/1666740784814_13889_3.png',
            previewUrl: null,
            provider: 'cloudinary',
            provider_metadata: {
              public_id: '2_39e32e2911',
...
describe('Components <PostGrid />', () => {
  it('should render <PostGrid />', () => {
    const { getByText, getAllByTestId } = customRender(
      <PostGrid posts={mockedPosts} />,
    );

    expect(getByText('Academia top Mais')).toBeInTheDocument();
    expect(getAllByTestId('coverPost')[0]).toBeInTheDocument();
    expect(getByText('Laurence, the First Vicar')).toBeInTheDocument();
    expect(getAllByTestId('coverPost')[1]).toBeInTheDocument();
    expect(getByText('Lyra Orphee Death Trip Serenade')).toBeInTheDocument();
    expect(getAllByTestId('coverPost')[2]).toBeInTheDocument();
  });
});
